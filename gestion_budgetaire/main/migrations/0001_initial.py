# Generated by Django 4.0 on 2022-01-01 20:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.scf_pos_1')),
            ],
        ),
        migrations.CreateModel(
            name='SCF_Pos_3',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('numero', models.IntegerField(primary_key=True, serialize=False)),
                ('rubrique', models.CharField(max_length=100)),
                ('chapitre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.chapitre')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commerciale', models.BooleanField(default=False, verbose_name='Recette indicateur')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_bdg', models.CharField(choices=[('PROPOS', 'Budget de proposition'), ('NOTIF', 'Budget notifié'), ('REALIS', 'budget de Réalisation')], max_length=50)),
